...
X_app_groups_full <- sparseMatrix(i=id_devices,j=id_app_groups,x=1,dimnames = list(unique_devices,unique_app_group),dims = c(length(unique_devices),length(unique_app_group)))
X_app_groups_activities_full <- sparseMatrix(i=id_devices,j=id_app_groups,x=(device.categories.length[,freq]),dimnames = list(unique_devices,unique_app_group),dims = c(length(unique_devices),length(unique_app_group)))
X_app_groups_activities_full.log <- sparseMatrix(i=id_devices,j=id_app_groups,x=log1p(device.categories.length[,freq]),dimnames = list(unique_devices,unique_app_group),dims = c(length(unique_devices),length(unique_app_group)))
...
X_categories_activities_full <- sparseMatrix(i=id_devices,j=id_categories,x=device.categories[,Nactivity],dimnames = list(unique_devices,unique_categories),dims = c(length(unique_devices),length(unique_categories)))
X_categories_activities_full.log <- sparseMatrix(i=id_devices,j=id_categories,x=log1p(device.categories[,Nactivity]),dimnames = list(unique_devices,unique_categories),dims = c(length(unique_devices),length(unique_categories)))
X_categories_activities_full.P <- sparseMatrix(i=id_devices,j=id_categories,x=device.categories[,Pactivity],dimnames = list(unique_devices,unique_categories),dims = c(length(unique_devices),length(unique_categories)))
X_categories_activities_full.Pm <- sparseMatrix(i=id_devices,j=id_categories,x=expm1(device.categories[,Pactivity]),dimnames = list(unique_devices,unique_categories),dims = c(length(unique_devices),length(unique_categories)))
...
X_locations_full <- sparseMatrix(i=id_devices,j=id_locations,x=1,dimnames = list(unique_devices,unique_locations),dims = c(length(unique_devices),length(unique_locations)))
X_locations_activities_full <- sparseMatrix(i=id_devices,j=id_locations,x=device.locations[,Nactivity],dimnames = list(unique_devices,unique_locations),dims = c(length(unique_devices),length(unique_locations)))
X_locations_activities_full.log <- sparseMatrix(i=id_devices,j=id_locations,x=log1p(device.locations[,Nactivity]),dimnames = list(unique_devices,unique_locations),dims = c(length(unique_devices),length(unique_locations)))
X_locations_activities_full.P <- sparseMatrix(i=id_devices,j=id_locations,x=device.locations[,Pactivity],dimnames = list(unique_devices,unique_locations),dims = c(length(unique_devices),length(unique_locations)))
X_locations_activities_full.Pm <- sparseMatrix(i=id_devices,j=id_locations,x=expm1(device.locations[,Pactivity]),dimnames = list(unique_devices,unique_locations),dims = c(length(unique_devices),length(unique_locations)))
